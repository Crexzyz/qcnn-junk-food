...
Usage:
    python -m src.headless.train_junk_food_multilabel
"""
...
CONFIG = {
    ...
    "seed": 42,
    # Output
    "output_dir": "runs/junk_food_multilabel",
    "log_interval": 10,
    "save_every": 1,
}
...
def parse_cli_overrides():
    ...
    parser = argparse.ArgumentParser(
        description="Train Quantum CNN on Junk Food (Multilabel)"
    )
...
def setup_logger(output_dir: str) -> logging.Logger:
    ...
    logger = logging.getLogger(f"train_junk_food_multilabel.{id(output_dir)}")
